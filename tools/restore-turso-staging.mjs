...
await restore(links,['sites','site_pages','crawl_runs','crawl_targets','crawl_observations','crawl_discoveries','discovery_queue','discovery_sitemap_cursor','index_results']);
