...
const inputTables = ['job_lock_events','job_locks','discovery_sitemap_cursor','crawl_targets','crawl_observations','crawl_discoveries','discovery_queue','site_pages','sites','crawl_runs'];
