...
إذا رمى طلب HTTP خطأً أو انتهى بمهلة في وضع `hybrid`، يحاول الزاحف Chromium مباشرةً بدل تجاوز fallback. يسجل log خطأ HTTP وخطأ المتصفح على حدة، مع تمييز timeout. وتُعطى صفحات نطاقات `.gov.eg` إشارة تصنيف مرشحة لفئة «حكومة وخدمات عامة»؛ ولا تتجاوز هذه الإشارة فحوص المحتوى والجودة.
