...
طريقة التشغيل المعتمدة حاليًا هي تشغيل Workflow **Baheth Masr Crawler** يدويًا من GitHub Actions، ثم اختيار `manual` وإدخال `manual_url` وتحديد `limit`. لا توجد لوحة Cloudflare إدارية مطلوبة حاليًا؛ Workers الإدارة التجريبية حُذفت، بينما Worker البحث مستقل ولم يتم تعديله.
