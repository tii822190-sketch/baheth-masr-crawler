...
const expectedDuplicate = 'تغيير لا يجب كتابته karam.com';
...
if (ftsRows.length !== 1 || ftsRows[0].search_text !== expectedDuplicate) throw new Error('FTS row was not replaced correctly');
